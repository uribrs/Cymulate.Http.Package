...
{
    public static IAuthenticationProvider Create(AuthSelection authSelection, ILoggerFactory loggerFactory)
    {
        return authSelection switch
        {
            ...
            AuthSelection.OAuth2(var config) => AuthProviderCollection.BuildOAuth2Provider(config, loggerFactory),
